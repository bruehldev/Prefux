...
prefux is a Java-based toolkit for building interactive information
...
prefux is written in Java 1.4, using the Java2D graphics library. To compile
...
prefux uses the Ant system from the Apache Group to compile the files. Ant is
...
button for "Select archive file" and browse for the prefux distribution
zip file. The "prefux" project should then appear in the area below.
Now just click the "Finish" button to import the project and build it.
Once prefux has been loaded as a project within Eclipse, you
can then run various demos directly from within Eclipse by right-clicking the
class file for a demo (e.g., demos/prefux.demos.GraphView.java) and
selecting "Run >> Java Application" from the menu.

--MORE--

Additional information and documentation, a help forum, a gallery of featured
prefux applications, and more, are available online. Point your web browser at
 -- http://prefux.org --
