 ...
 * {@link prefux.activity.Activity#run()},
 * {@link prefux.activity.Activity#runAt(long)}, and 
 * {@link prefux.activity.Activity#runAfter(Activity)}
 * methods. These will automatically call the
 * appropriate methods with the ActivityManager.</p>
 * 
 * <p>For {@link prefux.action.Action} instances, one can also register
 * the actions with a {@link prefux.Visualization} and use the
