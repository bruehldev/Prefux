...
/**
 * TableModel implementation that serves as an adapter between a prefux
...
public class PrefuseTableModel implements TableModel, TableListener {
     ...
     * @param table the underlying prefux table
     */
    ...
    /**
     * Initialize mapping between prefux table rows and the rows reported
     * by this model.
     */
    ...
    /**
     * Get the prefux table row for a row index into this table model.
     * @param rowIndex the row index in this table model
     * @return the corresponding prefux table row
     */
