...
/**
 * Swing component that displays a prefux Tree instance in a Swing
 * JTree component. Graph instances can also be displayed by first
 * getting a Tree instance with the
 * {@link prefux.data.Graph#getSpanningTree()} method.
 * 
...
public class JPrefuseTree extends JTree {
    ...
    /**
     * TreeModel implementation that provides an adapter to a backing prefux
     * Tree instance.
     */
    public class PrefuseTreeModel implements TreeModel, GraphListener {
        ...
        /**
         * @see prefux.data.event.GraphListener#graphChanged(prefux.data.Graph, java.lang.String, int, int, int, int)
         */
