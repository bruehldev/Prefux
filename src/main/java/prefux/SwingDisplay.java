 ...
 * {@link prefux.Visualization} from which it pulls the items to visualize.
 * </p>
 * 
 * <p>To control which {@link prefux.visual.VisualItem} instances are
 * drawn, the Display also maintains an optional 
 * {@link prefux.data.expression.Predicate} for filtering items. The
 * drawing order of items is
 * controlled by an {@link prefux.visual.sort.ItemSorter} instance,
 * which calculates a score for each item. Items with higher scores
 * are drawn later, and hence on top of lower scoring items.
 * </p>
 * 
 * <p>The {@link prefux.controls.Control Control}
 * interface provides the user interface callbacks for supporting
 * interaction. The {@link prefux.controls} package contains a number
 ...
 * {@link #zoom(prefux.data.util.Point2D,double) zoom}
 ...
 * {@link #editText(prefux.visual.VisualItem, String)} methods.</p>
 * 
 * @version 1.0
 * @author <a href="http://jheer.org">jeffrey heer</a>
 * @see Visualization
 * @see prefux.controls.Control
 * @see prefux.controls
 */
...
//	 * 
//	 */
//	private static final long serialVersionUID = 5010767989157997209L;
//
//	private static final Logger s_logger 
//        = Logger.getLogger(SwingDisplay.class.getName());
//    
//    // visual item source
...
//    protected Rectangle2D   m_rclip = Rectangle2D.EMPTY;
...
//     * {@link prefux.data.expression.parser.ExpressionParser} to get a
//     * {@link prefux.data.expression.Predicate} instance.
//     * @param visualization the {@link Visualization} backing this Display
//     * @param predicate a predicate expression in the prefux expression
...
//     */
//    public SwingDisplay(Visualization visualization, String predicate) {
//        this(visualization,
...
//     * Predicate.
//     * @param visualization the {@link Visualization} backing this Display
//     * @param predicate the filtering {@link prefux.data.expression.Predicate}
//     */
//    public SwingDisplay(Visualization visualization, Predicate predicate) {
...
//     * parsed by the {@link prefux.data.expression.parser.ExpressionParser}.
//     * If the parse fails or does not result in a
//     * {@link prefux.data.expression.Predicate} instance, an exception will
//     * be thrown.
//     */
...
//     * Sets the filtering Predicate used to control what items are drawn by
//     * this Display.
//     * @param p the filtering {@link prefux.data.expression.Predicate} to use
//     */
...
//     * by the ItemSorter.
//     * @return this Display's {@link prefux.visual.sort.ItemSorter}
//     */
...
//     * VisualItems. Items are drawn in ascending order of the scores provided
//     * by the ItemSorter.
//     * @return the {@link prefux.visual.sort.ItemSorter} to use
//     */
...
//     * @see prefux.util.ui.JCustomTooltip
//     */
...
//     * {@link prefux.visual.VisualItem#getBounds()} are not accurate and the
//     * item's {@link prefux.render.Renderer} is drawing outside of the
...
//    
//    /* (non-Javadoc)
//	 * @see prefux.Display#damageReport(javafx.geometry.Rectangle2D)
//	 */
//    @Override
...
//    
//    /* (non-Javadoc)
//	 * @see prefux.Display#damageReport()
//	 */
//    @Override
...
//        return getItemBounds(Rectangle2D.EMPTY);
//    }
//
//    /**
//     * Returns the bounds, in absolute (item-space) coordinates, of the total
...
//        b = new Rectangle2D(m_bounds.getMinX(), m_bounds.getMinY(),
//                               m_bounds.getWidth(), m_bounds.getHeight());
//        return b;
//    }
//    
//    // ------------------------------------------------------------------------
...
//                m_rclip = new Rectangle2D(
//                        m_clip.getMinX(), m_clip.getMinY(), 
//                        m_clip.getWidth(), m_clip.getHeight());
//                //g2D.setClip(m_rclip);
//                
...
//                        m_clip.getWidth()+pixel, m_clip.getHeight()+pixel);
//
//            } else {
//                // set the background region to clear
//                m_rclip = new Rectangle2D(m_screen.getMinX(),  m_screen.getMinY(),
...
//     * about paint events.
//     * @param pl the {@link prefux.util.display.PaintListener} to add
//     */
...
//     * @param pl the {@link prefux.util.display.PaintListener} to remove
//     */
...
//     * @param ibl the {@link prefux.util.display.ItemBoundsListener} to add
//     */
...
//     * occupied by the VisualItems in this Display change.
//     * @param ibl the {@link prefux.util.display.ItemBoundsListener} to remove
//     */
...
//        Rectangle r = null; //m_transform.createTransformedShape(b).getBounds();
//        
