...
import prefux.data.search.PrefixSearchTupleSet;
import prefux.data.search.SearchTupleSet;
import prefux.data.tuple.TupleSet;
import prefux.util.ui.JSearchPanel;
import prefux.visual.VisualTupleSet;

/**
 * DynamicQueryBinding supporting text search over data values. Implementations
 * of the {@link prefux.data.search.SearchTupleSet} class from the
 * {@link prefux.data.search} package can be used to control the type of
 * search index used.
 * 
 * @author <a href="http://jheer.org">jeffrey heer</a>
 * @see prefux.data.search.SearchTupleSet
 */
public class SearchQueryBinding extends DynamicQueryBinding {
     ...
     * @param ts the TupleSet to query
     * @param field the data field (Table column) to query
     * @param set the {@link prefux.data.search.SearchTupleSet} to use.
     */
     ...
     * @return the {@link prefux.data.search.SearchTupleSet} used by this
     ...
     * @return a {@link prefux.util.ui.JSearchPanel} bound to this
     * dynamic query.
     * @see prefux.data.query.DynamicQueryBinding#createComponent()
     */
