 ...
 * data collections in the prefux framework.
 * 
 * @author <a href="http://jheer.org">jeffrey heer</a>
 * @see prefux.data.Tuple
 */
public interface TupleSet {
     ...
     * Add a data field / column to this TupleSet's members.
     * @param name the name of the data field
     * @param expr an uncompiled expression in the prefux expression
     ...
     * @see prefux.data.expression
     * @see prefux.data.expression.parser.ExpressionParser
     */
     ...
     * Add a data field / column to this TupleSet's members.
     * @param name the name of the data field
     * @param expr a compiled expression in the prefux expression
