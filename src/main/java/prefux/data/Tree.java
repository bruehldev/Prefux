 ...
 * tables, and use {@link prefux.data.Node} and
 * {@link prefux.data.Edge} instances to provide object-oriented access
...
public class Tree extends Graph {
    ...
    /**
     * @see prefux.data.Graph#createLinkTable()
     */
    ...
    /**
     * @see prefux.data.Graph#updateDegrees(int, int, int, int)
     */
