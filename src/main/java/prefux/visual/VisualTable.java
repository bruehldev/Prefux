...
import prefux.visual.tuple.TableVisualItem;
...
public class VisualTable extends CascadedTable implements VisualTupleSet {
    ...
    /**
     * Set the given row's validated flag. This is for internal use by prefux
     ...
     * {@link prefux.action.assignment.ColorAction} might assign colors based on
     * the flag).
     * 
     * @param row
     *            the table row to set
    ...
    /**
     * Set the hover flag. This is set automatically by the prefux framework, so
     ...
     * {@link prefux.render.ShapeRenderer}.
     * 
     * @param row
     *            the table row
