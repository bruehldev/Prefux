...
import prefux.data.query.ObjectRangeModel;
...
public class AxisLayout extends Layout {
     ...
     * @param group the data group to layout
     * @param field the data field upon which to base the layout
     * @param axis the axis type, either {@link prefux.Constants#X_AXIS}
     * or {@link prefux.Constants#Y_AXIS}.
     */
     ...
     * {@link prefux.util.ui.ValuedRangeModel#getLowValue()} and
     * {@link prefux.util.ui.ValuedRangeModel#getHighValue()} methods.
     ...
     * {@link prefux.Constants#X_AXIS} or {@link prefux.Constants#Y_AXIS}.
     ...
     * {@link prefux.Constants#NUMERICAL}, or
     * {@link prefux.Constants#UNKNOWN}.
