 ...
 * this value.</p>
 * 
 * <p>The {@link prefux.util.force.ForceSimulator} used to drive this layout
 ...
 * {@link prefux.util.force.Force} components. Each node in the layout is
 * mapped to a {@link prefux.util.force.ForceItem} instance and each edge
 * to a {@link prefux.util.force.Spring} instance for storing the state
 * of the simulation. See the {@link prefux.util.force} package for more.</p>
 * 
